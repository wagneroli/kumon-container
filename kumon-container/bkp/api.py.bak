...
def premios_por_categoria(categoria_id):
    """GET premios da tabela lista_de_premios filtrados por categoria_id E status_presenca = PRESENTE"""
    try:
    ...
    try:
        ...
        cur.execute("""
            SELECT
                ...
                CONCAT(COALESCE(p.status_pago, 'NAO_PAGO'), '') as status_pago,
